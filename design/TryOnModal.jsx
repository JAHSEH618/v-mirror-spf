...
const TryOnModal = ({ isOpen, onClose, productImage, productName, availableColors }) => {
  const [selectedColor, setSelectedColor] = useState(availableColors[0]);
  const [userPhoto, setUserPhoto] = useState(null);
  const [viewState, setViewState] = useState('upload'); // 'upload' | 'loading' | 'result'
  ...
  const handleSelectModel = (modelImage) => {
